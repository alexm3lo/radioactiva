	...
	<body id="wp-admin" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">
		...
		function themify_insert_shortcode(type) {
			...
			switch(type){
				...
				case 'post_slider':
					sc_content = '[' + type + ' ' + themify_scparams( Array( 'limit', 'category', 'image', 'image_w', 'image_h', 'post_meta', 'more_text', 'visible', 'scroll', 'auto', 'wrap', 'speed', 'slider_nav', 'width', 'height', 'class', 'image_size', 'order', 'orderby' ), type ) + ']';
				break;
				
				case 'list_posts':
					sc_content = '[' + type + ' ' + themify_scparams(Array('limit', 'category', 'image', 'image_w', 'image_h', 'post_meta', 'more_text', 'post_date', 'style', 'image_size', 'order', 'orderby'), type) + ']';
				break;
