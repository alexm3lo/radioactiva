...
/***************************************************************************/	
	...
	function themify_page() {
        ...
        <p id="theme-title"><?php echo $theme->display('Name'); ?> <em><?php echo $theme->display('Version'); ?> (<a href="http://themify.me/logs/<?php echo strtolower($theme->display('Name')); ?>-changelogs" class="themify_changelogs" target="_blank"><?php _e('changelogs', 'themify'); ?></a>)</em></p>
					...
					<div class="featimgcontrol">
                        ...
                        <div class="themify_field_row clearfix">
							...
							<div class="themify_field_title"><?php echo $meta_box['title']; ?></div>
                            	...
                            	if($meta_value != '' || has_post_thumbnail()): ?>
                            	...
                            	<div id="remove-<?php echo $meta_box['name']; ?>" class="themify_featimg_remove <?php if( !has_post_thumbnail() && $meta_value == '' ) echo 'hide' ?>">
...
function themify_presstrends_theme() {
	...
	if ( !$data || $data == '' ) {
		...
		$posts_with_comments = $wpdb->get_var( $wpdb->prepare("SELECT COUNT(*) FROM $wpdb->posts WHERE post_type='post' AND comment_count > 0") );
		$data = array(
